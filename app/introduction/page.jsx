...
export default async function page() {
  ...
  return (
      ...
      <main className="flex flex-col text-center items-center h-screen">
        <div className="flex justify-center m-3 my-8 text-white">
          <b> 1 / {maxNum + 1}</b>
        </div>
          <div className="flex justify-center h-2/5 w-full lg:w-2/5 border-2 border-sky-950 rounded-lg bg-white">
            <Picture question_img_name = {"2.gif"} />
          </div>
        <div className="p-6 py-6 font-bold text-left text-white text-xl">{prompt}</div>
        <div className="">
